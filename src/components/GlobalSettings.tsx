        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <CardContent className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <Input defaultValue="KORTECK COMUNICACAO VISUAL LTDA" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Nome Fantasia</Label>
                      <Input defaultValue="KORTECK INDUSTRIES" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      <Label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">CNPJ (Tax ID)</Label>
                      <Input defaultValue="00.000.000/0001-00" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Inscrição Estadual</Label>
                      <Input defaultValue="ISENTO" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1.5">
                      ...
                      <Input defaultValue="admin@korteck.com.br" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                    </div>
                    <div className="space-y-1.5">
                      <Label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Telefone Central</Label>
                      <Input defaultValue="+55 (11) 4004-0000" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Logradouro Completo</Label>
                    <Input defaultValue="Av. Industrial, 1000 - Setor Alfa, São Paulo - SP" className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10" />
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <Select defaultValue="pt-BR">
                        <SelectTrigger className="bg-[#050505] border-white/5 text-white text-xs font-bold h-10">
            ...
            <TabsContent value="modules" className="mt-0 space-y-6 animate-in slide-in-from-left-2 duration-500">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <Card key={module.id} className="bg-[#0c0c10] border-white/5 hover:border-white/10 transition-colors">
                      <CardContent className="p-6">
                        <div className="flex items-start justify-between">
                          <div className="flex gap-4">
                            ...
                            <div>
                               <h4 className="text-xs font-black text-white uppercase italic tracking-widest">{module.label}</h4>
                  ...
                  <div className="p-8 space-y-8">
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                          ...
                          <div key={s.label} className="p-4 rounded-2xl bg-[#050505] border border-white/5 text-center">
                             <div className="text-[9px] font-black text-zinc-600 uppercase tracking-widest mb-1">{s.label}</div>
                     ...
                     <div className="space-y-4">
                        <div className="flex justify-between items-center px-1">
                           ...
                           <div className="text-[10px] font-black text-zinc-500">42.8 GB / 100 GB</div>
                        </div>
          ...
          <div className="space-y-6">
            <Card className="bg-[#0c0c10] border-white/5 p-8 shadow-2xl flex flex-col items-center text-center space-y-6">
              ...
              <div>
                 <h4 className="text-sm font-black text-white uppercase italic tracking-[0.2em] mb-2 text-amber-500">Aviso de Segurança</h4>
                 <p className="text-xs text-zinc-500 font-medium leading-relaxed italic">
                    Modificações nessas configurações podem afetar a visibilidade de dados e a performance operacional de todos os usuários do sistema <span className="text-white">ERP KORTECK</span>.
                 </p>
              </div>
              ...
              <div className="w-full space-y-4">
                 <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                       <div className="text-[9px] font-black text-white uppercase tracking-widest">Logs de Auditoria</div>
                       <div className="text-[8px] text-zinc-600 font-bold uppercase">Última alteração: Hoje, 09:42</div>
                    </div>
                 </div>
              </div>
            </Card>
            ...
            <Card className="bg-[#0c0c10] border-white/5 overflow-hidden">
               ...
               <CardContent className="p-6">
                  <div className="flex gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/5">
                     ...
                     <div>
                        <div className="text-[10px] font-black text-white uppercase tracking-widest">Atualização de Kernel</div>
                        <div className="text-[9px] text-zinc-500 font-medium">02:00 - 04:00 (Fuso Local)</div>
                     </div>
                  </div>
               </CardContent>
            </Card>
