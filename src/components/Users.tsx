    ...
    <div className="p-4 md:p-8 space-y-8 animate-in fade-in duration-700 max-w-[1700px] mx-auto pb-24">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-8 border-b border-white/5 pb-8">
        ...
        <div className="flex flex-wrap items-center gap-3">
           <div className="hidden lg:flex items-center gap-6 px-10 border-r border-white/5 mr-3">
              <div className="text-right">
                 <p className="text-[9px] font-black text-zinc-600 uppercase tracking-widest mb-1">USUÁRIOS ATIVOS</p>
           ...
           <Button className="bg-blue-600 text-white hover:bg-blue-500 font-black h-14 px-10 text-[11px] uppercase tracking-widest shadow-2xl shadow-blue-600/20 transition-all border-0">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        <div className="xl:col-span-8 flex flex-col gap-8">
           {/* Filters Bar */}
           <Card className="bg-[#0c0c10] border-white/5 backdrop-blur-xl">
             <CardContent className="p-6 flex flex-col md:flex-row items-center justify-between gap-6">
               <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-white/5 rounded-xl border border-white/10">
                     <Filter size={18} className="text-zinc-500" />
                  </div>
                  <div className="flex items-center gap-2 bg-white/[0.02] p-1 rounded-xl border border-white/5">
                    {['Todos', 'Ativo', 'Inativo', 'Pendente'].map((filter) => (
                      <Button
                        ...
                        className={cn(
                          ...
                          activeFilter === filter ? "bg-white text-black shadow-xl" : "text-zinc-600 hover:text-white"
                        )}
                      >
                        {filter}
                      </Button>
               ...
               <div className="relative w-full md:w-80">
                  ...
                  <Input 
                    className="bg-white/[0.02] border-white/5 h-12 pl-12 text-[10px] font-black uppercase tracking-widest text-white placeholder:text-zinc-700 font-mono" 
        ...
        <div className="xl:col-span-4 space-y-8">
          <Card className="bg-gradient-to-br from-blue-600/10 to-blue-900/20 border-blue-500/20 overflow-hidden relative p-10 border-2">
            ...
            <div className="relative z-10 space-y-8">
               ...
               <div className="p-6 bg-black/60 border border-white/5 rounded-3xl space-y-4">
               ...
               <div className="flex gap-3">
                  <Button className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-black text-[11px] uppercase h-14 tracking-widest shadow-2xl shadow-blue-600/20 shadow-black">
                     CONGELAR PERMISSÕES
                  </Button>
                  <Button variant="outline" className="h-14 border-white/10 text-zinc-500 hover:text-white uppercase font-black text-[10px]">
                     IGNORAR
                  </Button>
               </div>
            </div>
          ...
          <Card className="bg-[#0c0c10] border-white/5 p-10 space-y-10">
             <div>
                <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest italic mb-2">Hierarquia Operacional</h4>
                <p className="text-2xl font-black text-white italic tracking-tighter uppercase leading-none">Distribuição de Acesso</p>
             </div>
                ...
                {[
                  ...
                  <div key={i} className="group">
                    <div className="flex justify-between items-end mb-3">
                       <p className="text-[10px] font-black text-zinc-600 uppercase tracking-widest italic group-hover:text-white transition-colors">{item.label}</p>
                       <p className={cn("text-base font-black italic", item.color)}>{item.count}</p>
                    </div>
                    <Progress value={item.val} className="h-1 bg-white/5" indicatorClassName="bg-blue-500" />
                  </div>
                ))}
             </div>

             <Button variant="ghost" className="w-full h-14 text-[11px] font-black uppercase tracking-widest text-zinc-600 hover:text-white border border-white/5 hover:bg-white/5">
